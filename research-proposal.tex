...
\subsection{เพื่อศึกษากระบวนการ ความต้องการ และปัญหาในการจัดการและบันทึกการฝึกงานของคณะวิทยาศาสตร์ มหาวิทยาลัยราชภัฏจันทรเกษม}
\subsection{เพื่อออกแบบและพัฒนา Trainy ให้รองรับกระบวนการฝึกงานตั้งแต่เริ่มต้นจนถึงการประเมินและสรุปผล โดยเชื่อมโยงนักศึกษา อาจารย์ เจ้าหน้าที่ และสถานประกอบการ}
\subsection{เพื่อประเมินประสิทธิผลในการทำภารกิจ ปัญหาการใช้งาน และความสามารถในการใช้งานของ Trainy จากผู้ใช้ที่เกี่ยวข้อง}
\subsection{เพื่อจัดทำข้อเสนอแนะสำหรับปรับปรุงระบบบันทึกและติดตามการฝึกงานให้เหมาะสมกับการใช้งานจริง}
...
\subsection{ได้ข้อกำหนดระบบที่สะท้อนกระบวนการจริงของคณะวิทยาศาสตร์}
\subsection{ได้ระบบกลางที่ช่วยลดการแยกส่วนของข้อมูลและทำให้ติดตามสถานะได้ชัดเจนขึ้น}
\subsection{นักศึกษาสามารถบันทึกหลักฐานการเรียนรู้และความก้าวหน้าได้เป็นระบบ}
\subsection{อาจารย์ เจ้าหน้าที่ และพี่เลี้ยงสามารถตรวจสอบและให้ข้อเสนอแนะผ่านข้อมูลชุดเดียวกัน}
\subsection{ได้หลักฐานด้านการใช้งานและข้อเสนอแนะสำหรับพัฒนาระบบก่อนนำไปใช้จริงในวงกว้างขึ้น}
